...
const RegisterVerification = () => {
  ...
  const handleVerificationSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/dashboard"), 3000); // Delay navigation to show toast
    } catch (error) {
            ...
            <div className="max-w-full sm:max-w-lg lg:max-w-md mx-auto w-full">
              ...
              <div className="text-center">
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                    ...
                    <span className="font-semibold">
                      {localStorage.getItem("email") || "your email address"}
                    </span>{" "}
                    containing a code to verify your account.
                  </p>
                </div>
                ...
                <form onSubmit={handleVerificationSubmit} className="space-y-4 sm:space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-600 text-white py-2 sm:py-3 px-3 sm:px-4 rounded-lg font-medium text-sm sm:text-base hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors cursor-pointer"
                  >
                    Confirm
                  </button>
                </form>
