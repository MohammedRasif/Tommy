            ...
            <div className="flex w-full  mx-auto ">
                ...
                <div className="w-2/5 p-8 flex flex-col justify-center">
                    <div className="max-w-full mx-auto w-full">
                        <h1 className="text-5xl font-bold text-[#454D3C] mb-8 text-center">Change Password</h1>

                        <form onSubmit={handleSubmit} className="space-y-6 px-32">
                            {/* Email Field */}
                            <div >
                                <label className="block text-sm  text-gray-700 mb-2 font-semibold">New Password</label>
